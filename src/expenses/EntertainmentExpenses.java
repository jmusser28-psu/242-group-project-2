...
public class EntertainmentExpenses {
    ...
    public EntertainmentExpenses(boolean isMonthly) {
        ...
        if (isMonthly) {
            System.out.print("Please enter entertainment spending for January: ");
            monthlyExpense[0] = DoubleValidation.validate();
            System.out.print("Please enter entertainment spending for February: ");
            monthlyExpense[1] =  DoubleValidation.validate();
            System.out.print("Please enter entertainment spending for March: ");
            monthlyExpense[2] =  DoubleValidation.validate();
            System.out.print("Please enter entertainment spending for April: ");
            monthlyExpense[3] =  DoubleValidation.validate();
            System.out.print("Please enter entertainment spending for May: ");
            monthlyExpense[4] =  DoubleValidation.validate();
            System.out.print("Please enter entertainment spending for June: ");
            monthlyExpense[5] =  DoubleValidation.validate();
            System.out.print("Please enter entertainment spending for July: ");
            monthlyExpense[6] =  DoubleValidation.validate();
            System.out.print("Please enter entertainment spending for August: ");
            monthlyExpense[7] =  DoubleValidation.validate();
            System.out.print("Please enter entertainment spending for September: ");
            monthlyExpense[8] =  DoubleValidation.validate();
            System.out.print("Please enter entertainment spending for October: ");
            monthlyExpense[9] =  DoubleValidation.validate();
            System.out.print("Please enter entertainment spending for November: ");
            monthlyExpense[10] =  DoubleValidation.validate();
            System.out.print("Please enter entertainment spending for December: ");
