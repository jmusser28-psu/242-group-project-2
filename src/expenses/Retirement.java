...
public class Retirement {
    ...
    public Retirement(boolean isMonthly) {
        ...
        if (isMonthly) {
            System.out.print("Please enter retirement contributions for January: ");
            monthlyExpense[0] = DoubleValidation.validate();
            System.out.print("Please enter retirement contributions for February: ");
            monthlyExpense[1] =  DoubleValidation.validate();
            System.out.print("Please enter retirement contributions for March: ");
            monthlyExpense[2] =  DoubleValidation.validate();
            System.out.print("Please enter retirement contributions for April: ");
            monthlyExpense[3] =  DoubleValidation.validate();
            System.out.print("Please enter retirement contributions for May: ");
            monthlyExpense[4] =  DoubleValidation.validate();
            System.out.print("Please enter retirement contributions for June: ");
            monthlyExpense[5] =  DoubleValidation.validate();
            System.out.print("Please enter retirement contributions for July: ");
            monthlyExpense[6] =  DoubleValidation.validate();
            System.out.print("Please enter retirement contributions for August: ");
            monthlyExpense[7] =  DoubleValidation.validate();
            System.out.print("Please enter retirement contributions for September: ");
            monthlyExpense[8] =  DoubleValidation.validate();
            System.out.print("Please enter retirement contributions for October: ");
            monthlyExpense[9] =  DoubleValidation.validate();
            System.out.print("Please enter retirement contributions for November: ");
            monthlyExpense[10] =  DoubleValidation.validate();
            System.out.print("Please enter retirement contributions for December: ");
        ...
        // Takes in user input if the user decided to enter in yearly expenses
            ...
            System.out.print("Please enter a yearly retirement contribution: ");
